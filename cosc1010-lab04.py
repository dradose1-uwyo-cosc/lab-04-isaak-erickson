...
average_max_temp = sum_max_temps / count
average_min_temp = sum_min_temps / count
...
print(f"Highest Recorded Maximum Temperature: {highest_max_temp}")
print(f"Lowest Recorded Minimum Temperature: {lowest_min_temp}")
